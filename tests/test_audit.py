...
def test_hash_chain_integrity():
    ...
    with Session(engine) as session:
        first = append_audit_log(session, {"action": "a", "decision": "x", "details": {}, "agent_id": 1, "user_id": None, "tool_name": "echo", "trace_id": "t1"})
        second = append_audit_log(session, {"action": "b", "decision": "y", "details": {}, "agent_id": 1, "user_id": None, "tool_name": "echo", "trace_id": "t2"})
